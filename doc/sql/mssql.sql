...
-- ----------------------------
-- Primary Key structure for table etl_data_check
-- ----------------------------
ALTER TABLE [dbo].[etl_data_check] ADD CONSTRAINT [PK__etl_data__3213E83F64C005CB] PRIMARY KEY CLUSTERED ([id])
...
-- ----------------------------
-- Auto increment value for etl_data_sync
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[etl_data_sync]', RESEED, 10)
GO


-- ----------------------------
-- Primary Key structure for table etl_data_sync
-- ----------------------------
ALTER TABLE [dbo].[etl_data_sync] ADD CONSTRAINT [PK__etl_data__3213E83FE11BB7E4] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Auto increment value for etl_data_sync_log
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[etl_data_sync_log]', RESEED, 67)
GO


-- ----------------------------
-- Primary Key structure for table etl_data_sync_log
-- ----------------------------
ALTER TABLE [dbo].[etl_data_sync_log] ADD CONSTRAINT [PK__etl_data__3213E83FA7ED2AC5] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Auto increment value for etl_job
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[etl_job]', RESEED, 7)
GO


-- ----------------------------
-- Auto increment value for etl_job_log
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[etl_job_log]', RESEED, 27)
GO


-- ----------------------------
-- Primary Key structure for table etl_robot
-- ----------------------------
ALTER TABLE [dbo].[etl_robot] ADD CONSTRAINT [PK__etl_robo__3213E83FEFBA1485] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table etl_server
-- ----------------------------
ALTER TABLE [dbo].[etl_server] ADD CONSTRAINT [PK__etl_serv__ED5B5C5865DDEE7B] PRIMARY KEY CLUSTERED ([server_id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Auto increment value for etl_workflow_log
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[etl_workflow_log]', RESEED, 125)
GO
